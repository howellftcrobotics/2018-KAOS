...
public class KILTS_RobotMecCore
{
    ...
    private final String RIGHT_LIFT_MOTOR = "right_lift";
    private final String LEFT_LIFT_MOTOR = "left_lift" ;
    ...
    private final String GRABBER_SERVO_1 = "grabber_servo_1";
    private final String GRABBER_SERVO_2 = "grabber_servo_2";

    final double GRABBER_SERVO_1_CLOSED = .90;
    final double GRABBER_SERVO_1_OPEN = 0;
    final double GRABBER_SERVO_2_CLOSED = .90;
    final double GRABBER_SERVO_2_OPEN = 0;
    ...
    public KILTS_RobotMecCore(OpModeConfig opModeConfig)
    {
    ...
    public boolean init()
    {
        ...
        m_opModeConfig.LogInfo("Initializing drive motors...");
        try
        {
            ...
            m_opModeConfig.LogInfo("Initializing drive motors complete...");
        }
        catch (Exception ex)
        {
        ...
        m_opModeConfig.LogInfo("Initializing lift motors...");
        try
        {
            leftLiftMotor = m_opModeConfig.OpMode.hardwareMap.get(DcMotor.class, LEFT_LIFT_MOTOR);
            rightLiftMotor = m_opModeConfig.OpMode.hardwareMap.get(DcMotor.class, RIGHT_LIFT_MOTOR);

            // set all the lift motors to zero power
            ...
            // set default direction of lift motors
            ...
            m_opModeConfig.LogInfo("Initializing lift motors complete...");
        }
        catch (Exception ex)
        {
            // something went wrong
            m_opModeConfig.LogError("Initializing Lift Motors Exception: " + ex.getMessage());
            result = false;
        }

        //initialize the mineral motor
        m_opModeConfig.LogInfo("Init mineral motor...");
        try
        {
            ...
            mineralMotor.setZeroPowerBehavior(DcMotor.ZeroPowerBehavior.BRAKE);
        ...
        //initialize the extender motor
        m_opModeConfig.LogInfo("Init extender motor...");
        try
        {
        ...
        // configure grabber servo 1
        m_opModeConfig.LogInfo("Init grabber servo 1...");
        try
        {
            grabberServo1 = m_opModeConfig.OpMode.hardwareMap.get(Servo.class, GRABBER_SERVO_1);
        }
        catch (Exception ex)
        {
            // something went wrong
            m_opModeConfig.LogError("Initializing grabber servo 1 Exception: " + ex.getMessage());
            //result = false;
        }

        // configure grabber servo 2
        m_opModeConfig.LogInfo("Init grabber servo 2...");
        try
        {
            grabberServo2 = m_opModeConfig.OpMode.hardwareMap.get(Servo.class, GRABBER_SERVO_2);
        }
        catch (Exception ex)
        {
            // something went wrong
            m_opModeConfig.LogError("Initializing grabber servo 2 Exception: " + ex.getMessage());
            //result = false;
        }
        ...
        m_opModeConfig.LogInfo("Init complete...", true);
        return  result;
    }

    public void OpenGrabber()
    {
        RobotUtil.TrySetServoPosition(grabberServo1, GRABBER_SERVO_1_OPEN);
        RobotUtil.TrySetServoPosition(grabberServo2, GRABBER_SERVO_2_OPEN);
    }

    public void CloseGrabber()
    {
        RobotUtil.TrySetServoPosition(grabberServo1, GRABBER_SERVO_1_CLOSED);
        RobotUtil.TrySetServoPosition(grabberServo2, GRABBER_SERVO_2_CLOSED);
    }

...
@TeleOp(name="KUDOS_TeleOp_MecDrive", group="KUDOS")
@Disabled
public class KUDOS_TeleOp_MecDrive extends LinearOpMode
{
    ...
    public KUDOS_TeleOp_MecDrive()
    {
        ...
        m_robot = new KUDOS_RobotMecCore(m_coreConfig);
    }
